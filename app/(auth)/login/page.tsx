      ...
      <div className="flex-1 flex items-center justify-center px-5 py-8">
        <div className="w-full max-w-md">
          <div className="mb-6 md:mb-8 flex justify-center">
            <LogoPill text="Selamat Datang Kembali" />
          </div>
          ...
          <p className="md-default text-text-placeholder mb-8 text-center leading-relaxed">
            Lanjutkan deteksi penyakit daun tomat Anda dan akses riwayat
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className="sm-default text-text-label group-hover:text-text-action transition-colors">
                  Ingat saya
                </span>
              </label>
              <Link
                href="/forgot-password"
                className="sm-default text-text-action hover:text-text-action-hover transition-colors"
              >
                Lupa kata sandi?
              </Link>
            </div>
